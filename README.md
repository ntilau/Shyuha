...
This repository aggregates research documents, datasets, and findings related to Rwanda's energy sector, with a special focus on geothermal energy potential, exploration, and development. It serves as a centralized knowledge base for researchers, policymakers, and stakeholders interested in Rwanda's sustainable energy transition.

---

## Table of Contents
- [Project Focus](#project-focus)
- [Business Plan and Strategy](#business-plan-and-strategy)
  - [Vision](#vision)
  - [Mission](#mission)
...
The Shyuha project collects and organizes information about:

- Rwanda's national energy mix (hydropower, solar, methane, peat, biomass) and sector planning
- Geothermal energy prospects in the northwestern volcanic zone (Gisenyi, Karisimbi, Kinigi) and southern rift-fault area (Bugarama)
- Exploration efforts, drilling results, and feasibility studies for geothermal development
- International cooperation projects, particularly JICA-supported initiatives for energy sector planning
- Rwanda's energy access goals (universal access by 2024) and sustainable development strategies
- Climate commitment alignment, including Rwanda's 2030 emissions-reduction pledge
...
### Vision
To become the leading knowledge resource and implementation partner for renewable energy projects in Rwanda, with a focus on geothermal direct-use applications, solar power optimization, and water pumping efficiency.

### Mission
To accelerate Rwanda's sustainable energy transition by:
1. Providing actionable research and analysis for geothermal, solar, and water-energy nexus projects
2. Developing bankable business models for renewable energy implementation
3. Facilitating knowledge transfer between researchers, policymakers, investors, and local communities
4. Supporting pilot projects that demonstrate viability and scalability of renewable energy solutions

### Three-Pillar Strategy

#### Pillar 1: Geothermal Direct-Use Applications (Near-Term Focus)
Based on analysis showing fastest ROI and lowest technical risk:
- **Target Applications**: Greenhouse heating, aquaculture, industrial process heat
- **Implementation Phases**:
  - Phase 1 (0-18 months): Pilot direct-use projects at Gisenyi or Bugarama (50-200kW thermal)
  - Phase 2 (12-36 months): Scale to industrial and municipal applications
  - Phase 3 (24-60 months): Electrical generation from confirmed resources
- **Revenue Models**: Energy savings contracts, joint ventures with agribusiness, PPP arrangements
- **Key Advantages**: 6-18 month ROI, displacement of imported diesel, alignment with food security goals

#### Pillar 2: Solar Power ROI Optimization (Mid-Term)
Leveraging Rwanda's excellent solar resource (4.8 kWh/m²/day):
- **Target Systems**: 100kW-10MW PV installations for Kigali City
- **Focus Areas**:
  - Pilot systems on government buildings, schools, hospitals
  - Commercial/industrial rooftop installations
  - Utility-scale grid-connected projects with storage
- **Financial Mechanisms**: PPAs, green bonds, development finance, concessional loans
- **Payback Period**: 2.6-5.7 years depending on system size and financing

#### Pillar 3: Water-Pumping Energy Efficiency (Cross-Cutting)
Addressing Kigali's significant water-pumping energy burden (~$5.2M/year):
- **Optimization Strategies**:
  - High-efficiency pumps and motors
  - Variable frequency drives (VFDs)
  - Solar PV integration for daytime pumping
  - Leak detection and pressure management
- **Integration Opportunities**:
  - Geothermal-assisted heat pumps for water facilities
  - Solar-powered pumping stations
  - Energy recovery from pressure reduction valves

### Market Analysis
- **Geothermal Potential**: Conservative estimate of 100MW, with higher estimates exceeding 700MW
- **Electricity Access Gap**: 49% of households lack reliable power (universal access target by 2024)
- **Energy Import Dependence**: Rwanda imports significant diesel for thermal generation
- **Agricultural Opportunity**: 70% of population engaged in agriculture; cold chain and processing needs
- **Industrial Growth**: Increasing demand for reliable, clean process heat in food/textiles sectors

### Revenue Streams
1. **Consulting Services**: Feasibility studies, technical analysis, bankable documentation
2. **Project Development Fees**: Structuring and packaging renewable energy projects
3. **Technology Licensing**: Access to analyzed data, models, and implementation frameworks
4. **Carbon Credit Aggregation**: Facilitating access to international carbon markets
5. **Knowledge Products**: Premium reports, datasets, and analytical tools

### Risk Management Framework
- **Technical Risk**: Start with proven direct-use technologies before electrical generation
- **Market Risk**: Secure off-take agreements before major investments
- **Financial Risk**: Utilize concessional financing and staged capital deployment
- **Regulatory Risk**: Align with MININFRA and REG frameworks; engage early with authorities
- **Execution Risk**: Partner with experienced EPC contractors and local implementers

### Partnership Strategy
- **Government**: MININFRA, REG, RDB, REMA for policy alignment and facilitation
- **Financial Institutions**: DFIs, local banks, climate funds for project financing
- **Technical Partners**: 
  - Geothermal consultants, solar EPCs, engineering firms
  - **Kenya Partnerships**: KenGen, GDC, and Kenyan technical institutes for geothermal knowledge transfer
- **Local Implementation**: Cooperatives, agribusinesses, industrial parks, municipal utilities
- **Research Institutions**: University of Rwanda, IPRC, international research organizations
...
- **Scale and Replicate** (2029 and Beyond)
- **Cross-Cutting Activities** (Knowledge Management, Partnerships, M&E)

To view or contribute to the project tracking:
1. Visit the [Shyuha GitHub Projects board](https://github.com/ntilau/Shyuha/projects/1)
2. Review open issues and project cards
3. Contribute by suggesting new activities or updating progress on existing items

### Call to Action
Researchers, investors, and policymakers interested in collaborating on renewable energy initiatives in Rwanda are encouraged to:
1. Explore the research documents in this repository
2. Contact us for partnership opportunities
3. Contribute new findings or datasets to expand our knowledge base
4. Join our working groups focused on specific technology applications
...
### Recommended Kenya-Rwanda Cooperation Framework:
...
## Current Status (as of research completion)
...
2. [African Geothermal Association - Rwanda Profile](https://africangeothermal.org/countries/rwanda/)
3. [UNIDO Geothermal Fact Sheet for Rwanda (PDF)](https://downloads.unido.org/ot/32/09/32096187/Geothermal%20fact%20sheet%20for%20promoting%20PPP%20-Rwanda.pdf)
4. [Rwanda Dispatch - Geothermal Schemes Article](https://rwandadispatch.com/geothermal-schemes-boost-powers-rwandas-carbon-reduction-drive/)
...
## Key Assumptions (Based on Rwanda-Specific Data)
...
## Economic Analysis by System Size

### 100kW System
- **CAPEX**: 100 kW × 750,000 RWF/kW = 75,000,000 RWF (~$65,000 USD)
- **Annual generation**: 100 kW × 4.8 h/day × 365 days × 0.85 (system losses) ≈ 148,920 kWh/year
- **Annual revenue**: 148,920 kWh × 182 RWF/kWh ≈ 27,103,440 RWF (~$23,500 USD)
...
### 500kW System
- **CAPEX**: 500 kW × 750,000 RWF/kW = 375,000,000 RWF (~$325,000 USD)
...
### 1MW System
- **CAPEX**: 1 MW × 750,000 RWF/kW = 750,000,000 RWF (~$650,000 USD)
...
### 5MW System
- **CAPEX**: 5 MW × 750,000 RWF/kW = 3,750,000,000 RWF (~$3.25 million USD)
...
### 10MW System (Reference: Gesto Energy Project)
...
- **Annual generation**: ~41,900,000 kWh/year (10MW × 4.8 × 365 × 0.85)
...
## Comparison with Conventional Power Generation

### Diesel Generation Comparison
...
1. **Installation cost**: ±20% changes payback by ±0.6 years
2. **Solar yield**: ±0.5 h/day changes payback by ∓0.3 years
3. **Electricity tariff**: ±20% changes payback by ∓0.6 years
4. **O&M costs**: ±50% changes payback by ±0.2 years

## Recommendations for Kigali City Implementation
### Phased Approach:
...
## Sources
1. [Rwanda Solar Panel ROI Calculator | AfroTools](https://afrotools.com/tools/solar-roi/rwanda/)
2. [Gesto Energy | Rwanda 10MW Solar PV Development](https://gestoenergy.com/project/rwanda-10mw-solar-pv-development/)
3. [Utility-Scale Solar Cost Per MW 2026: EPC Bid Guide](https://www.reslink.org/blogs/utility-scale-solar-farm-cost-per-mw-2026-guide/)
4. [Solar - Rwanda Energy Group](https://www.reg.rw/what-we-do/generation/solar/)
5. [AFROTools Estimate solar payback in Rwanda](https://afrotools.com/fr/tools/roi-solaire/rwanda/)
...
## Rwanda's Hot Springs Resources
...
- **Annual Pumping Cost**: ~$5.2 million USD/year (at Rwanda's tariff of ~$0.16/kWh)

## Profitability Analysis by Application Type
...
- Binary Cycle Geothermal Plant: $2,500-$4,000 per kW installed
- 100kW Plant: $250,000-$400,000
- 1MW Plant: $2.5-$4.0 million
- 5MW Plant: $12.5-$20.0 million
- 10MW Plant: $25.0-$40.0 million

**Operating Costs**:
- O&M: 1-3% of CAPEX annually
- Minimal fuel costs (geothermal heat is free)
- Parasitic load: ~10-15% of gross generation

**Revenue Streams**:
- Electricity Sales: At Rwanda's tariff (~$0.16/kWh for commercial/industrial)
- Potential for PPAs (Power Purchase Agreements) with utilities or industries
- Carbon credits: Potential additional revenue from emissions reduction

**ROI Calculations for Electrical Generation**:
*Assumptions: 85% capacity factor, 25-year lifespan, 0.5% annual degradation*
...
### 2. Direct Thermal Applications (More Immediate ROI Potential)
Direct use of geothermal heat (without electricity conversion) offers significantly better ROI due to:
- Higher efficiency (70-90% vs 10-15% for electricity generation)
- Lower capital costs (no power conversion equipment needed)
- Immediate displacement of expensive thermal fuels

#### Applicable Direct Use Scenarios for Rwanda:
**A. Water Pumping Assistance (Most Promising)**
- **Concept**: Use geothermal heat to reduce electrical energy needed for water pumping
- **Methods**:
  1. **Thermal Boosting**: Pre-heat water to reduce pumping work (limited applicability)
  2. **Absorption Cooling/Heating**: For HVAC in water treatment facilities
  3. **Hybrid Systems**: Geothermal-assisted heat pumps for pumping stations
  4. **Direct Steam Use**: If sufficient pressure/temperature available (unlikely at 70-75°C)

**B. Greenhouse Heating for Agriculture**
- **Temperature Suitability**: 70-75°C ideal for greenhouse heating
- **Applications**: 
  - Vegetable production (tomatoes, peppers, cucumbers)
  - Flower cultivation (roses, carnations for export)
  - Seedling nurseries
- **Economic Benefits**:
  - Displace diesel/biomass heating ($0.50-$1.00/liter diesel equivalent)
  - Extended growing seasons
  - Higher yields and quality
  - Potential export market access

**C. Aquaculture (Fish Farming)**
- **Temperature Suitability**: 70-75°C suitable for tropical fish species
- **Applications**:
  - Tilapia farming (optimal 28-30°C, requires mixing)
  - Catfish cultivation
...
**D. Industrial Process Heat**
- **Applications**:
  - Food processing (pasteurization, drying, sterilization)
  - Textile industry (dyeing, drying)
  - Breweries (mashing, wort boiling)
  - Dairy processing (pasteurization)
- **Temperature Match**: 70-75°C suitable for many low-to-medium temperature processes

#### Direct Use ROI Analysis
**Assumptions**:
- Direct thermal efficiency: 75% (heat exchanger + distribution losses)
- Displaced fuel: Diesel at 1,700 RWF/L (~$1.50/L) with 10 kWh/L thermal equivalent
- Effective cost of displaced heat: ~$0.15/kWh thermal
- Geothermal heat cost: Near zero (only pumping/capital costs)

**Capital Cost Estimates**:
- Direct Use System (heat exchangers, piping, controls): $500-$1,500 per kW thermal
- 100kW thermal system: $50,000-$150,000
- 500kW thermal system: $250,000-$750,000
- 1MW thermal system: $0.5-$1.5 million

**Annual Savings Calculation**:
*For a 500kW thermal system operating 8,000 hours/year:*
- Thermal energy delivered: 500 kW × 8,000 h × 0.75 efficiency = 3,000,000 kWh thermal/year
- Displaced diesel: 3,000,000 kWh ÷ 10 kWh/L = 300,000 L diesel/year
- Cost savings: 300,000 L × 1,700 RWF/L = 510,000,000 RWF/year (~$443,000 USD/year)
- **Simple Payback**: 0.5-1.5 years (based on CAPEX range)

### Comparison: Electrical vs. Direct Use ROI
...
## Highest Potential for Success and Fastest ROI

### Ranked Opportunities for Rwanda:
...
## Implementation Recommendations for Shyuha Project

### Phase 1: Direct Use Pilots (0-18 months)
...
### Phase 2: Industrial and Municipal Applications (12-36 months)
...
### Phase 3: Electrical Generation (24-60 months)
...
### Direct Use Scenario (500kW thermal greenhouse heating):
...
### Electrical Generation Scenario (1MW binary plant):
...
- **Grid Benefits**: 
  ...
  - Carbon emissions reduction (~4,200 tons CO2/year avoided)

## Kenya Geothermal Best Practices: Lessons for Rwanda
...
### Drilling Best Practices from Kenya
...
### Steam Power Generation Best Practices
1. **Steam Field Management**: Kenya employs sophisticated reservoir monitoring including pressure/temperature tracking, tracer testing, and production profiling to optimize steam field longevity.
...
### Implementation Recommendations for Shyuha
...
### Phase 1: Foundation Building (Q4 2026 - Q2 2027)
**Duration: 6 months**
...
### Phase 2: Pilot Implementation (Q3 2027 - Q4 2028)
**Duration: 6 months**
...
### Phase 3: Scale and Replicate (2029 and Beyond)
**Ongoing**
...
## Cross-Cutting Activities (Throughout All Phases)
...
### Phase 1 Completion (End Q2 2027)
...
### Phase 2 Completion (End Q4 2028)
...
- Water pumping energy audit completed at Karenge treatment plant
...
- Quarterly: Progress tracking and minor adjustments
- Biannually: Significant revisions based on pilot results and changing conditions
- Annually: Comprehensive review aligned with Rwanda's national planning cycles
...
```mermaid
gantt
    title Shyuha Project Implementation Timeline (2026-2029+)
    dateFormat  YYYY-MM
    section Foundation Building (Q4 2026 - Q2 2027)
    Geothermal Direct-Use Analysis           :active,    g1, 2026-10, 6m
    Temperature & Flow Measurements          :           , g1, 2026-11, 4m
    Agricultural Cooperatives Engagement     :           , g1, 2026-12, 5m
    Kenya-Rwanda Technical Exchange          :           , g1, 2027-01, 6m
    Professional Capacity Building           :           , g1, 2027-02, 6m
    Pilot System Design                      :           , g1, 2027-03, 5m
    section Solar Power Optimization
    Solar ROI Modeling Finalization          :active,    g2, 2026-10, 6m
    Site Identification for Pilots           :           , g2, 2026-11, 4m
    Policy Engagement (MININFRA/REG)         :           , g2, 2026-12, 5m
    Solar Financing Concepts Development     :           , g2, 2027-01, 6m
    section Water-Pumping Efficiency
    Preliminary Assessment                   :active,    g3, 2026-10, 3m
    Pumping Stations Identification          :           , g3, 2026-11, 3m
    VFDs & Solar Integration Research        :           , g3, 2027-01, 4m
    Gravity-Fed Options Mapping              :           , g3, 2027-02, 4m
    section Pilot Implementation (Q3 2027 - Q4 2028)
    100kW Thermal Greenhouse Pilot Launch    :active,    p1, 2027-07, 6m
    Monitoring System Installation           :           , p1, 2027-08, 5m
    Business Model Development               :           , p1, 2027-09, 4m
    Exploratory Drilling (Kinigi/Gisenyi)    :           , p1, 2027-10, 6m
    Reservoir Management Implementation      :           , p1, 2028-01, 6m
    Aquaculture Heating Pilots               :           , p1, 2028-03, 4m
    section Solar Power Optimization (Continued)
    500kW Solar PV Deployment                :active,    p2, 2027-07, 5m
    Net Metering Implementation              :           , p2, 2027-08, 4m
    Commercial/Industrial Solar Outreach     :           , p2, 2027-09, 6m
    Solar PPA Templates Development          :           , p2, 2027-10, 5m
    Grid Impact Studies                      :           , p2, 2028-01, 6m
    section Water-Pumping Efficiency (Continued)
    Karenge Treatment Plant Audit            :active,    p3, 2027-07, 4m
    VFD Implementation                       :           , p3, 2027-08, 5m
    Solar PV Pumping Pilot                   :           , p3, 2027-09, 4m
    Leak Detection & Repair Initiative       :           , p3, 2027-10, 5m
    Geothermal-Assisted Heat Pumps Exploration:          , p3, 2028-01, 4m
    section Scale and Replicate (2029 and Beyond)
    Pilot Expansion to Additional Sites      :active,    s1, 2029-01, 24m
    1-5MW Geothermal Binary Plants           :           , s1, 2029-06, 24m
    Franchise Model Development              :           , s1, 2029-03, 18m
    Kenyan Joint Ventures (>5MW Projects)    :           , s1, 2029-09, 24m
    Local Drilling Capacity Development      :           , s1, 2029-06, 24m
    Advanced Reservoir Management            :           , s1, 2029-09, 18m
    section Solar Power Optimization (Continued)
    1-5MW Commercial/Industrial Solar        :active,    s2, 2029-01, 24m
    Utility-Scale Solar with Storage (5MW+)  :           , s2, 2029-06, 24m
    Local Solar Assembly Capabilities        :           , s2, 2029-03, 18m
    Solar Financing Vehicle                  :           , s2, 2029-09, 18m
    Solar-Agricultural Processing Integration:           , s2, 2029-12, 18m
    section Water-Pumping Efficiency (Continued)
    System-Wide Pump/Motor Upgrades          :active,    s3, 2029-01, 24m
    Solar PV Pumping Expansion               :           , s3, 2029-06, 24m
    Pressure Management Programs             :           , s3, 2029-03, 24m
    Hydropower Recovery Exploration          :           , s3, 2029-09, 18m
    Integrated Renewable Pumping Systems     :           , s3, 2029-12, 18m
    section Cross-Cutting Activities (Ongoing)
    Knowledge Management                     :crit,      c1, 2026-10, 36m
    Partnership Development                  :crit,      c2, 2026-10, 36m
    Monitoring & Evaluation                  :crit,      c3, 2026-10, 36m
    section Risk Management Milestones
    Exploration Risk Mitigation Phase 1      :           , r1, 2026-10, 9m
    Exploration Risk Mitigation Phase 2      :           , r1, 2027-07, 9m
    Market Risk Mitigation Phase 1           :           , r2, 2026-10, 9m
    Market Risk Mitigation Phase 2           :           , r2, 2027-07, 9m
    Technical Risk Mitigation Phase 1        :           , r3, 2026-10, 9m
    Technical Risk Mitigation Phase 2        :           , r3, 2027-07, 9m
    Financial Risk Mitigation Phase 1        :           , r4, 2026-10, 9m
    Financial Risk Mitigation Phase 2        :           , r4, 2027-07, 9m
    section Success Criteria
    Phase 1 Completion                       :milestone, m1, 2027-06, 1d
    Phase 2 Completion                       :milestone, m2, 2028-12, 1d
    Phase 3 Milestones Begin                 :milestone, m3, 2029-01, 1d
```

## How to Use This Chart

This GANTT chart provides a visual representation of the Shyuha project timeline. For implementation tracking:
...
- **Foundation Building** (Q4 2026 - Q2 2027): Analysis, partnerships, Kenya exchange program
- **Pilot Implementation** (Q3 2027 - Q4 2028): 100kW thermal pilot, 500kW solar, exploratory drilling
- **Scale and Replicate** (2029 and Beyond): Expand pilots, 1-5MW geothermal plants, joint ventures with Kenyan partners
- **Cross-Cutting Activities**: Knowledge management, partnership development, monitoring & evaluation (ongoing)

*Chart last updated: September 2026*
...
geothermal-energy rwanda energy-sector jica-projects sustainable-development
