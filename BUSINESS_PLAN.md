# Geothermal Power Generation Business Plan for Rwanda

## Executive Summary

This business plan outlines a comprehensive strategy for developing geothermal power generation capacity in Rwanda, leveraging the country's significant geothermal resources to meet growing electricity demand, reduce dependence on fossil fuels, and support national development goals. The plan focuses on a phased approach that begins with resource validation and pilot projects, progressing to commercial-scale power plants that will contribute to Rwanda's target of increasing installed capacity from 216 MW to 512 MW by 2024 and achieving 100% electricity access.
...
### 1.1 Vision
To become Rwanda's leading geothermal power producer, providing clean, reliable, and affordable baseload electricity to support the nation's industrialization and sustainable development goals.
...
### 2.2 Geothermal Resource Assessment
...
#### Competitive Advantages of Geothermal
...
#### Market Positioning
The venture will position itself as a provider of clean, reliable baseload power that complements Rwanda's existing hydro resources and reduces dependence on expensive diesel generation. Long-term PPAs will provide revenue certainty while supporting national grid stability.

## 3. Technology Description

### 3.1 Selected Technology: Binary Cycle Organic Rankine Cycle (ORC)
...
### 3.3 Technology Partners and Best Practices
...
Primary: Rwanda Energy Group (REG) through Power Purchase Agreements (PPAs)
Secondary: Large industrial customers seeking reliable, clean power (mines, manufacturing)
Tertiary: Off-grid or mini-grid applications for remote communities
...
Chief Executive Officer (CEO)
    |
    |----------------|----------------|----------------|
Chief Technical Officer (CTO)  Chief Financial Officer (CFO)  Chief Operations Officer (COO)
    |                      |                      |
Geothermal Team          Finance Team         Operations Team
Drilling/Reservoir       Accounting/Reporting Plant Management
Power Plant              Treasury/Financing   Maintenance
Environmental            Investor Relations   Health & Safety
Community Relations                              Grid Integration
```
...
#### Phase 1: Foundation and Validation (Q4 2026-Q2 2027)
...
#### Phase 2: Pilot Implementation and Exploration (Q3 2027-Q4 2028)
...
#### Phase 3: Commercial Scale (2029 and beyond)
...
#### Assumptions for 5-10 MW Binary Cycle Plant
...
#### Example O&M for 5 MW Plant ($16.25M CAPEX)
...
#### 5 MW Plant Example ($16.25M CAPEX)
| Metric | Calculation | Value |
|--------|-------------|-------|
| Annual Revenue | 37.2 GWh × $0.16/kWh | $5.95 million |
...
#### 10 MW Plant Example ($32.5M CAPEX)
| Metric | Calculation | Value |
|--------|-------------|-------|
| Annual Revenue | 74.4 GWh × $0.16/kWh | $11.9 million |
...
### 7.6 Financial Sensitivities

#### Key Variables Impacting Project Economics
...
**Objective**: Validate resource potential, establish partnerships, prepare for drilling
**Duration**: 6 months
**Key Activities**:
- Complete geothermal direct-use profitability analysis
- Conduct detailed temperature and flow rate measurements at Gisenyi and Bugarama
...
- Identify potential sites for pilot solar installations
...
**Deliverables**:
- Validated geothermal resource data
- Established technical partnerships
- Capacity building program underway
- Pilot direct-use system design completed
- Financial models for geothermal, solar, and water pumping efficiency

#### Phase 2: Pilot Implementation (Q3 2027-Q4 2028)
**Objective**: Demonstrate viability through pilots, commence exploration drilling
**Duration**: 6 months (Note: Timeline appears compressed in source doc - likely 18 months)
**Key Activities**:
...
- Water pumping efficiency improvements demonstrated
- Financing mechanisms identified for scale-up

#### Phase 3: Scale and Replicate (2029 and Beyond)
**Objective**: Commercial geothermal power generation and nationwide expansion
**Duration**: Ongoing
**Key Activities**:
...
**Deliverables**:
- Commercial geothermal power plants operational
- Nationwide direct-use franchise model
- Local drilling capacity established
- Integrated renewable energy solutions deployed
- Measurable impact on energy access and renewable targets
...
### 9.1 Critical Risks (Score 20-25)

#### R1: No Commercially Viable Resource Found
...
#### R2: Duplication with EDCL Efforts
...
### 9.2 High Risks (Score 12-16)

#### R3: GRMF Ineligibility
- **Likelihood**: 4 (Likely)
- **Impact**: 4 (Major)
- **Score**: 16 High
...
#### R6: Drilling Costs Exceed Budget
- **Likelihood**: 4 (Likely)
- **Impact**: 3 (Moderate)
- **Score**: 12 High
...
### 10.1 National Energy Contribution
...
### 10.2 Employment and Skills Development
...
### 10.4 Alignment with National Goals

#### Vision 2020 and NST1
...
*This business plan synthesizes research from SUMMARY.md, HOT_SPRINGS_ENERGY_PROFITABILITY.md, PROJECT_TIMELINE.md, RISK_REGISTER.md, and other documents in the Shyuha repository. Financial estimates are based on available public data and industry benchmarks. Site-specific feasibility studies are recommended for accurate project economics.*
